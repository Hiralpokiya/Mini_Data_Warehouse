...
Script Purpose:
    ...
    NOTE: CASCADE is used on all DROP statements to automatically remove
    any dependent Gold views before recreating Silver tables.
    After running this script, always re-run the Gold DDL script to
    recreate the Gold views.
===============================================================================
*/
