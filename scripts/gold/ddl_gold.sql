...
Script Purpose:
    ...
    NOTE: Always run this script AFTER running the Silver DDL and Silver
    stored procedure, as these views depend on Silver tables having data.
...
Usage:
    ...
    4. CALL silver.load_silver();
    Then run this script.
===============================================================================
*/

-- =============================================================================
-- Drop existing Gold views safely
-- =============================================================================
