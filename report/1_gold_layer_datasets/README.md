...
* PK: Primary Key
* FK: Foreign Key
* More Info about the gold layer : [docs/gold](https://github.com/Hiral-G-23/SQL-Data-Warehouse-Project/tree/main/docs/gold)
* More info about the gold scripts : [scripts/gold](https://github.com/Hiral-G-23/SQL-Data-Warehouse-Project/tree/main/scripts/gold)
