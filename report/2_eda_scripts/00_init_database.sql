...
FROM 'C:\Users\HP\OneDrive\Desktop\MIni-Data Warehouse\report\1_gold_layer_datasets\dim_customers.csv'
DELIMITER ','
CSV HEADER;
...
FROM 'C:\Users\HP\OneDrive\Desktop\MIni-Data Warehouse\report\1_gold_layer_datasets\dim_products.csv'
DELIMITER ','
CSV HEADER;
...
FROM 'C:\Users\HP\OneDrive\Desktop\MIni-Data Warehouse\report\1_gold_layer_datasets\fact_sales.csv'
DELIMITER ','
CSV HEADER;
----------------------------------------------------------------------------------------------------
...
copy gold.dim_customers(customer_id, customer_number, first_name, last_name, country, marital_status, gender, birth_date, create_date)
 FROM 'C:\Users\HP\OneDrive\Desktop\MIni-Data Warehouse\report\1_gold_layer_datasets\dim_customers.csv' WITH (FORMAT CSV, HEADER, DELIMITER ',');
...
FROM 'C:\Users\HP\OneDrive\Desktop\MIni-Data Warehouse\report\1_gold_layer_datasets\dim_products.csv' WITH (FORMAT CSV, HEADER, DELIMITER ',');
...
FROM 'C:\Users\HP\OneDrive\Desktop\MIni-Data Warehouse\report\1_gold_layer_datasets\fact_sales.csv' WITH (FORMAT CSV, HEADER, DELIMITER ',');
----------------------------------------------------------------------------------------------------
